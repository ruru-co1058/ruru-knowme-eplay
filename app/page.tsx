...
export default function Home(){
 ...
 return <main className="hub-shell">
  ...
  <section className="hub-hero" id="top"><div className="hero-copy"><p className="hero-kicker"><Sparkles/>一起玩・一起發現</p><h1>今天想玩<br/><em>哪一個遊戲？</em></h1><p>六位動物朋友歡樂合作！動動眼睛、動動腦，挑一個喜歡的遊戲開始挑戰吧！</p><a className="hero-jump" href="#games">選擇遊戲 <ChevronRight/></a></div><div className="hero-art"><img src="/game-friends.png" alt="鸚鵡、穿山甲、羊駝、水豚、小熊貓和水獺一起合作玩遊戲"/><span className="art-sticker">合作樂無窮！</span></div></section>
